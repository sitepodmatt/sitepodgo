...
func (c *SystemUserClient) UIDOf(obj interface{}) (string, bool) {
...
func (c *SystemUserClient) BySitepodKeyFunc() func(string) []interface{} {
...
func (c *SystemUserClient) CloneItem(orig interface{}) *v1.SystemUser {
	cloned, err := conversion.NewCloner().DeepCopy(orig)
	if err != nil {
		panic(err)
	}
	return cloned.(*v1.SystemUser)
}
...
func (c *SystemUserClient) DeleteFunc() func(interface{}) {
	return func(iTarget interface{}) {

		target := iTarget.(*v1.SystemUser)
